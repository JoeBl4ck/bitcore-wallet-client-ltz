...
var BASE_URL = 'https://bws.litecoinz.org/bws/api';
 ...
 * @param {string} opts.coin[='ltz'] - The coin for this wallet (ltz).
 ...
 * @param {String} copayerName
 * @param {Object} opts
 * @param {string} opts.coin[='ltz'] - The expected coin for this wallet (ltz).
...
API.signTxProposalFromAirGapped = function(key, txp, unencryptedPkr, m, n, opts) {
  ...
  var newClient = new API({
    baseUrl: 'https://bws.litecoinz.org/bws/api'
  });
